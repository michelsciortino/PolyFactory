    ...
    private static class Gui extends AnvilInputGui {
        ...
        private void updateDone() {
            this.setSlot(1, GuiTextures.BUTTON_DONE.get().setName(CommonComponents.GUI_DONE).setCallback(x -> {
                ...
                b.sendData(this.blockEntity.level, this.blockEntity.getBlockState().getValue(DataExtractorBlock.FACING_OUTPUT), this.blockEntity.getBlockPos(), this.blockEntity.lastInput(), player.getRandom().nextInt());
                this.close();
            }));
